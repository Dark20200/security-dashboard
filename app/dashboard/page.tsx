...
<motion.div
  ...
  className="p-6 bg-[#15151a]/80 border border-white/10 rounded-2xl hover:border-purple-500/40 transition backdrop-blur-sm max-w-2xl mx-auto text-center"
>

  {/* ✔️ العنوان ثابت بدون أي حركة */}
  <h2 className="text-xl font-semibold text-purple-400 mb-2 flex items-center justify-center gap-2">
    🧠 <span>AI Threat Analysis & Scanning</span>
  </h2>

  {/* ⭐ RotatingText في النص */}
  <div className="flex justify-center">
    <RotatingText />
  </div>

  {/* الإيموجي البنفسجي (الأعمدة المتحركة) في النص */}
  <div className="flex justify-center">
    <AnimatedBars />
  </div>
</motion.div>
